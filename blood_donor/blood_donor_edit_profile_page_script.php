...
if(isset($_POST['update'])){
    ...
    $update="UPDATE `blood_donor` SET `pass`='$u_Pass',`name`='$u_D_Name',`age`='$u_Age',`address`='$u_Address',`blood_grp`='$u_Blood_Group',`phone_no`='$u_Phone_No',`image`='$u_image' WHERE `id`='$id' ";
